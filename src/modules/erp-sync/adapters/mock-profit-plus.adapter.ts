...
export class MockProfitPlusAdapter implements ProfitPlusAdapter {
  ...
  private readonly inventory: ErpInventoryItem[] = [
    ...
    },
    {
      ...
      categoryCode: 'proteccion',
      categoryLabel: 'Protección',
      retailPrice: 14.9,
      wholesalePrice: 11.4,
      cost: 8.2,
      stock: 4,
    ...
    },
    {
      ...
      categoryCode: 'tableros',
      categoryLabel: 'Tableros',
      retailPrice: 42,
      wholesalePrice: 34,
      cost: 26,
      stock: 0,
    ...
    },
    {
      ...
      categoryCode: 'tomas',
      categoryLabel: 'Tomas e interruptores',
      retailPrice: 3.1,
      wholesalePrice: 2.25,
      cost: 1.4,
      stock: 540,
  ...
  async reportSale(sale: ErpSaleExport): Promise<void> {
    await delay(100);
    this.logger.log(
      `[mock] reported sale for order ${sale.orderId}: ${sale.items.length} line(s), total ${sale.total}`,
    );
  }

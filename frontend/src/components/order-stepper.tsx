import { CheckCircle2, CreditCard, PackageCheck, Truck, Ban, Clock } from "lucide-react";

export type OrderStatus =
  "pending_payment_verification" | "paid" | "preparing" | "shipped" | "fulfilled" | "cancelled";
...
const PIPELINE: { status: OrderStatus; label: string; icon: typeof CreditCard }[] = [

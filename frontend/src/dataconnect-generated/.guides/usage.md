...
```ts
import { useCreateUser, useCreateProduct, useAddToCart, useGetMyCart } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetMyCart();
...
```js
import { createUser, createProduct, addToCart, getMyCart } from '@dataconnect/generated';
